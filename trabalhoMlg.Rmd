...
# Modelo com função de ligação logit (regressão logística)
model_logit <- glm(Cancelamento ~ Tempo + Idoso + MultiplasLinhas, family = binomial(link = "logit"), data = train)

# Modelo com função de ligação probit
model_probit <- glm(Cancelamento ~ Tempo + Idoso + MultiplasLinhas, family = binomial(link = "probit"), data = train)

# Modelo com função de ligação cloglog
model_cloglog <- glm(Cancelamento ~ Tempo + Idoso + MultiplasLinhas, family = binomial(link = "cloglog"), data = train)

# Calcular o AIC de cada modelo
...
O modelo com a função de ligação cloglog apresentou os melhores
resultados em quase todos os critérios de avaliação, incluindo o menor
AIC, maior Log-Likelihood, menor Deviance, e o melhor desempenho em
Pseudo-R².
